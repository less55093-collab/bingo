...
@Composable
fun BingoLoadingIndicator(modifier: Modifier = Modifier) {
        ...
        AndroidView(
            ...
            factory = { context ->
                ImageView(context).apply {
                    val drawable = AppCompatResources.getDrawable(context, R.drawable.bingo_loading) as? AnimatedVectorDrawable
