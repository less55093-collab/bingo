...
fun ChatDrawerContent(
    ...
    val accountVm: AccountVM = koinViewModel(viewModelStoreOwner = activity)
                ...
                profile?.let {
                    Column(
                        modifier = Modifier
                            ...
                            .clickable { navController.navigate(Screen.Account) }
    ...
    Column {
        Row(
            ...
            DrawerQuickAction(
                ...
                label = stringResource(R.string.chat_page_menu_professional_image_generation),
