...
import me.rerere.rikkahub.ui.pages.account.RedeemPage
import me.rerere.rikkahub.ui.pages.tutorial.TutorialPage
        ...
        LaunchedEffect(tts) {
            eventBus.events.collect { event ->
                when (event) {
                    ...
                    is AppEvent.ImageGenerationEnded -> Unit // 由 ChatNotificationManager 消费
                }
            }
        }
